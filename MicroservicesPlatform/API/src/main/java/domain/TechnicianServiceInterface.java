...
//---------------------------------------------------------------------EDIT------------------------------------------------------------------//
//                                                                                                                                           //
    @RequestMapping(value = "/TechnicianService/Technicians/{technicianID}", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE)
...
//                                                                                                                                           //
    ...
    @RequestMapping(method = RequestMethod.DELETE, value = "/TechnicianService/Technicians/{technicianID}", params = {"technicianID"})
